...
public class MoonStoneBlock extends UniversalexpansionModElements.ModElement {
	@ObjectHolder("universalexpansion:moon_stone")
	public static final Block block = null;
	public MoonStoneBlock(UniversalexpansionModElements instance) {
		super(instance, 25);
	}
