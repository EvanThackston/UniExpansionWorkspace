...
public class PineFenceBlock extends UniversalexpansionModElements.ModElement {
	@ObjectHolder("universalexpansion:pine_fence")
	public static final Block block = null;
	public PineFenceBlock(UniversalexpansionModElements instance) {
		super(instance, 24);
	}
