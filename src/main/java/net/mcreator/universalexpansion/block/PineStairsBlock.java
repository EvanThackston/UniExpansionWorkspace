...
public class PineStairsBlock extends UniversalexpansionModElements.ModElement {
	@ObjectHolder("universalexpansion:pine_stairs")
	public static final Block block = null;
	public PineStairsBlock(UniversalexpansionModElements instance) {
		super(instance, 22);
	}
