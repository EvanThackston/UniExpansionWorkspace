...
package net.mcreator.universalexpansion.world.structure;
...
public class MeteoritestructureStructure extends UniversalexpansionModElements.ModElement {
	public MeteoritestructureStructure(UniversalexpansionModElements instance) {
		super(instance, 2);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 5000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("universalexpansion", "meteorite"));
						if (template == null)
							return false;
